...
# Builds the unit-test target (if needed) and runs the AddOp test suite.
#
# Usage: ./tools/run_add_op_tests.sh [options]
#
# Options:
...
#   --filter <name>      gtest filter (default: AddOp.*)
...
if [[ "$NO_BUILD" != "true" ]]; then
    echo "======================================"
    echo "AetherMind AddOp Test Runner"
    echo "======================================"
