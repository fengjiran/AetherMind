...
| 04 | [CPU GEMM 优化方案](04-cpu-gemm-optimization.md) | In Progress | 2026-09-17 |
...
- [04-cpu-gemm-optimization.md](04-cpu-gemm-optimization.md)：共享 CPU GEMM engine、scalar/SIMD/packed-weight 路径、shape specialization、分层 benchmark 与证据门禁。
