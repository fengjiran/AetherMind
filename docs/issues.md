...
- [ ] GEMM G0 尚缺三项 production 门禁证据：裸机 perf/governor/microcode、稳定 5% 级性能门禁（WSL2 噪声 floor 在 binding/小形状超阈值）、raw artifact 的 CI/object-storage retention URL（关联：[04 号提案 §7 G0](improvement-plan/04-cpu-gemm-optimization.md)、[配对 A/B 验证报告](tests/operators/gemm/gemm_g0_paired_ab_validation_2026-09-18.md)）
