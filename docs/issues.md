...
- [ ] GEMM 尚缺三项 production 门禁证据：裸机 perf/governor/microcode、稳定 5% 级性能门禁（WSL2 噪声 floor 在 binding/小形状超阈值）、raw artifact 的 CI/object-storage retention URL（关联：[GEMM 证据记录与状态](operators/gemm/README.md)）
