#ifndef AETHERMIND_GRAPH_OPTIMIZATION_CONST_EVAL_INTERNAL_H
#define AETHERMIND_GRAPH_OPTIMIZATION_CONST_EVAL_INTERNAL_H
...
// ── Cost estimation ──
// EstimateCost (declared in const_evaluator.h) implements the generic
