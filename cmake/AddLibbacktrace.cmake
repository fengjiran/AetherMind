...
function(_libbacktrace_compile)
    ...
    set(_libbacktrace_source ${PROJECT_SOURCE_DIR}/3rdparty/libbacktrace)
    set(_libbacktrace_prefix ${PROJECT_BINARY_DIR}/3rdparty/libbacktrace)
#    message(STATUS ${CMAKE_CURRENT_SOURCE_DIR})
    message(STATUS "backtrace src dir:" ${_libbacktrace_source})
    message(STATUS "backtrace bin dir:" ${_libbacktrace_prefix})
