...
| 04 | [CPU GEMM 优化方案](../operators/gemm/cpu-gemm-optimization.md) | In Progress | 2026-09-19 |
...
- [04-cpu-gemm-optimization.md](../operators/gemm/cpu-gemm-optimization.md)：共享 CPU GEMM engine、scalar/SIMD/packed-weight 路径、shape specialization、分层 benchmark 与证据门禁。只承载优化原理与工作包状态，机器级数值见 [GEMM 实验记录与验证报告索引](../operators/gemm/README.md)。（04 专项于 2026-09-19 归入算子文档目录 `docs/operators/gemm/`）
