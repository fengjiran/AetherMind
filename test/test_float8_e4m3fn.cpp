...
TEST(Float8E4M3FNTest, OneValue) {
    EXPECT_EQ(1.0f, fp8e4m3fn_to_fp32_value(0x3C));
}

TEST(Float8E4M3FNTest, NegativeOneValue) {
    EXPECT_EQ(-1.0f, fp8e4m3fn_to_fp32_value(0xBC));
}

TEST(Float8E4M3FNTest, MaxPositiveValue) {
    EXPECT_FLOAT_EQ(448.0f, fp8e4m3fn_to_fp32_value(0x7F));
}
...
TEST(Fp8E4M3FnToFp32Test, DenormalizedValues) {
...
TEST(Fp8E4M3FnToFp32Test, NormalizedValues) {
...
TEST(Fp8E4M3FnToFp32Test, SpecialValues) {
...
TEST(Fp8E4M3FnToFp32Test, RoundingCases) {
